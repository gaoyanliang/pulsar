...
public class Namespaces extends NamespacesBase {
    ...
    public void grantPermissionOnNamespace(@PathParam("tenant") String tenant,
                                           ...
                                           @ApiParam(value = "List of permissions for the specified role")
    ...
    public void grantPermissionOnSubscription(@PathParam("property") String property,
                                              ...
                                              @ApiParam(value = "List of roles for the specified subscription")
                                                      Set<String> roles) {
    ...
    public void setPublishRate(@PathParam("property") String property, @PathParam("namespace") String namespace,
                               @ApiParam(value = "Publish rate for all topics of the specified namespace")
    ...
    public void deleteSubscribeRate(@Suspended AsyncResponse asyncResponse, @PathParam("tenant") String tenant,
                                    @PathParam("namespace") String namespace) {
        validateNamespaceName(tenant, namespace);
        internalDeleteSubscribeRateAsync().thenAccept(asyncResponse::resume).exceptionally(ex -> {
    ...
    public void setSubscribeRate(@Suspended AsyncResponse asyncResponse, @PathParam("tenant") String tenant,
        ...
        validateNamespaceName(tenant, namespace);
        internalSetSubscribeRateAsync(subscribeRate).thenAccept(asyncResponse::resume).exceptionally(ex -> {
            log.error("Failed to delete the subscribeRate for cluster on namespace {}", namespaceName, ex);
            resumeAsyncResponseExceptionally(asyncResponse, ex);
            return null;
        });
    ...
    public void setMaxProducersPerTopic(@PathParam("tenant") String tenant, @PathParam("namespace") String namespace,
                                        @ApiParam(value = "Number of maximum producers per topic", required = true)
    ...
    public void setMaxConsumersPerTopic(@PathParam("tenant") String tenant, @PathParam("namespace") String namespace,
                                        @ApiParam(value = "Number of maximum consumers per topic", required = true)
